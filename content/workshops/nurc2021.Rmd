...
|-------------|------------|--------------------|--------------------------------------------------------------------------------------|----------------|
| nurc_2021   | <a href="/static/workshops/nurc2021_files/nurc_2021.zip" class="text-link">.zip</a>| [View on GitHub](https://github.com/andr3wli/nurc-r-website/blob/master/content/problem_sets/nurc_2021_folder/nurc_2021.ipynb) | * Intro to Jupyter <br>* Reading in Data<br>* Data wrangling<br>* Data visualization<br> * The pipe operator | 20             |
